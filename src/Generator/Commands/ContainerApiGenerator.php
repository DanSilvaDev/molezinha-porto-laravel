...
namespace Molezinha\Generator\Commands;

use Molezinha\Generator\GeneratorCommand;
use Molezinha\Generator\Interfaces\ComponentsGenerator;
...
class ContainerApiGenerator extends GeneratorCommand implements ComponentsGenerator
{
     ...
     * @var string
     */
    protected $name = 'molezinha:generate:container:api';
    ...
    public function getUserInputs()
    {
        ...
        $this->call('molezinha:generate:readme', [
        ...
        $this->call('molezinha:generate:configuration', [
            '--container'   => $containerName,
            '--file'        => $_containerName,
        ]);
        ...
        $this->call('molezinha:generate:serviceprovider', [
            '--container'   => $containerName,
        ...
        $this->call('molezinha:generate:model', [
            '--container'   => $containerName,
            '--file'        => $model,
            '--repository'  => true,
        ]);
        ...
        $this->call('molezinha:generate:migration', [
            '--container'   => $containerName,
        ...
        $this->call('molezinha:generate:transformer', [
            '--container'   => $containerName,
        ...
        {
            $this->call('molezinha:generate:route', [
                '--container' => $containerName,
                '--file' => $route['name'],
                '--ui' => $ui,
            ...
            $this->call('molezinha:generate:request', [
                '--container' => $containerName,
                '--file' => $route['request'],
                '--ui' => $ui,
            ...
            $this->call('molezinha:generate:action', [
                '--container' => $containerName,
                '--file' => $route['action'],
                '--model' => $model,
                '--stub' => $route['stub'],
            ...
            $this->call('molezinha:generate:task', [
                '--container' => $containerName,
                '--file' => $route['task'],
                '--model' => $model,
                '--stub' => $route['stub'],
        ...
        $this->call('molezinha:generate:controller', [
            '--container'   => $containerName,
            '--file'        => 'Controller',
            '--ui'          => $ui,
            '--stub'        => 'crud.' . $ui,

        ...
        if (File::isDirectory($directory)) {
            ...
            foreach ($files as $file) {
                ...
                if (File::isFile($file)) {
                    ...
                    if (Molezinha::stringStartsWith($file->getFilename(), $mainServiceProviderNameStartWith)) {

                        $serviceProviderClass = Molezinha::getClassFullNameFromFile($file->getPathname());

...
trait RoutesLoaderTrait
{
    ...
    {
        return Config::get('molezinha.api.url');
    }
    ...
    {
        return Config::get('molezinha.api.prefix') . (Config::get('molezinha.api.enable_version_prefix') ? $this->getRouteFileVersionFromFileName($file) : '');
    }
    ...
    private function getRateLimitMiddleware()
    {
        ...
        if (Config::get('molezinha.api.throttle.enabled')) {
            $rateLimitMiddleware = 'throttle:' . Config::get('molezinha.api.throttle.attempts') . ',' . Config::get('molezinha.api.throttle.expires');
        }
